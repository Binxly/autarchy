...
# Setup theme links
mkdir -p ~/.config/autarchy/themes
for f in ~/.local/share/autarchy/themes/*; do ln -nfs "$f" ~/.config/autarchy/themes/; done
...
ln -snf ~/.config/autarchy/current/theme/btop.theme ~/.config/btop/themes/current.theme

mkdir -p ~/.config/mako
ln -snf ~/.config/autarchy/current/theme/mako.ini ~/.config/mako/config
